...
const updatePage = async () => {
  ...
  const sweetFruits = fruitsArray.filter(fruit => fruit.nutritions.sugar > 15.0);
  console.log(sweetFruits);

  // TODO: Create a new HTML element to display your data
  const newElement = document.createElement('div');
  newElement.className = "fruits";
  sweetFruits.forEach(function(entry) {
    newElement.innerHTML += entry.name + " ";
  });
